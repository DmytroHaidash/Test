...
if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
    ...
    if(isset($_POST["email"])){
        ...
        if(!empty($email)){
            ...
            // Проверка формата почтового адреса и его уникальности
    ...
    //  Код добавления пользователя в БД

    //Запрос на добавления пользователя в БД
    $result_query_insert = $mysqli->query("INSERT INTO `users` (first_name, last_name, email, password, description)
 VALUES ('$first_name', '$last_name', '$email', '$password', '$description')");
    ...
    if(!$result_query_insert){
        ...
        $_SESSION["success_messages"] = "<p class='success_message'>Регистрация прошла успешно!!! <br />
Теперь Вы можете авторизоваться используя Ваш логин и пароль.</p>";
